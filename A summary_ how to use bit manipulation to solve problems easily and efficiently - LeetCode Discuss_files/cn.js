...
<a href="https://support.leetcode-cn.com/hc/kb/article/1252597/' + UTMLink + '&utm_content=sub_sync" style="color: orange;">轻松数据同步使用已有积分</a>\
</span></div></div>' + `
<style>
      ...
      <div style="margin-left: 170px">
        ...
        <div style="font-size: 12px; margin-top: 5px; margin-bottom: 10px;">
          <span style="opacity: 0.7;">新功能推荐：
            ...
            <a href="https://support.leetcode-cn.com/hc/kb/article/1252597/${UTMLink2}&utm_content=sub_sync" style="color: rgba(239,108,0,1);">轻松数据同步使用已有积分</a>
          </span>
        </div>
      </div>
